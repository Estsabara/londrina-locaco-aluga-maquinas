...
export const concretagemMisturaProducts: Product[] = [
  {
    ...
    price: 150,
    imageUrl: "https://images.tcdn.com.br/img/img_prod/668181/betoneira_400_litros_c_carregador_1_5cv_mono_prime_csm_860_1_57542d4eafc14c32cca177e99d7bfa5e.jpg",
  ...
  },
  {
    ...
    price: 90,
    imageUrl: "https://www.ferramentaskennedy.com.br/wordpress/wp-content/uploads/2018/05/misturador-de-argamassa-csm.jpg",
    category: "Concretagem e Mistura",
    available: true,
    brand: "Menegotti",
    model: "MX-60",
  ...
  },
  {
    ...
    price: 110,
    imageUrl: "https://www.crismaquinas.com.br/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/v/i/vibrador-de-concreto-eletrico-2HP.jpg",
    category: "Concretagem e Mistura",
    available: true,
    brand: "Wacker Neuson",
    model: "IREN38",
  ...
  },
  {
    ...
    price: 45,
    imageUrl: "https://static.ferramentasgerais.com.br/static/img/products/0000001900/large/0000001900.jpg",
    category: "Concretagem e Mistura",
    available: true,
    brand: "Wacker Neuson",
    model: "Variados",
  ...
  },
  {
    ...
    price: 120,
    imageUrl: "https://http2.mlstatic.com/D_NQ_NP_751489-MLB42219890012_062020-O.webp",
    category: "Concretagem e Mistura",
    available: true,
    brand: "Honda",
    model: "GX160",
  ...
  },
  {
    ...
    price: 95,
    imageUrl: "https://www.palaciodaferragem.com.br/media/catalog/product/cache/1/image/800x/9df78eab33525d08d6e5fb8d27136e95/v/i/vibrador-de-concreto-eletrico-wacker-m3000_11693.jpg",
    category: "Concretagem e Mistura",
    available: true,
    brand: "Wacker Neuson",
    model: "M2000",
